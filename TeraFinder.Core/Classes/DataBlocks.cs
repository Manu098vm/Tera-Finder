...
public static class Blocks
{
    ...
    public static readonly DataBlock KTeraRaidPaldea = new()
    {
        ...
        Pointer = new long[] { 0x4622A30, 0x198, 0x88, 0x40 },
        IsEncrypted = false,
        Size = 0xC98,
    };
    ...
    public static readonly DataBlock KTeraRaidKitakami = new()
    {
        ...
        Key = 0x100B93DA,
        Type = SCTypeCode.Object,
        Pointer = new long[] { 0x4622A30, 0x198, 0x88, 0xCD8 },
        IsEncrypted = false,
        Size = 0x1910,
    };
    ...
    public static readonly DataBlock KMyStatus = new()
    {
        ...
        Key = 0xE3E89BD1,
        Type = SCTypeCode.Object,
        Pointer = new long[] { 0x46215F0, 0x10, 0x40 },
        IsEncrypted = false,
        Size = 0x68,
    };
    ...
    public static readonly DataBlock RaidSevenStar = new()
    {
        ...
        Key = 0x8B14392F,
        Type = SCTypeCode.Object,
        Pointer = new long[]{ 0x4622A30, 0x198, 0x88, 0x25E8 },
        IsEncrypted = false,
        Size = 0x5DC0,
    };
    #endregion
    ...
    public static readonly DataBlock KBCATFixedRewardItemArray = new()
    {
        ...
        Key = 0x7D6C2B82,
        Type = SCTypeCode.Object,
        Pointer = new long[] { 0x46447C0, 0x08, 0x288, 0xE340, 0x0 },
        IsEncrypted = false,
        Size = 0x6B40,
    };
    ...
    public static readonly DataBlock KBCATLotteryRewardItemArray = new()
    {
        ...
        Key = 0xA52B4811,
        Type = SCTypeCode.Object,
        Pointer = new long[] { 0x46447C0, 0x08, 0x288, 0xE378, 0x0 },
        IsEncrypted = false,
        Size = 0xD0D8,
    };
    ...
    public static readonly DataBlock KBCATRaidEnemyArray = new()
    {
        ...
        Key = 0x0520A1B0,
        Type = SCTypeCode.Object,
        Pointer = new long[] { 0x46447C0, 0x08, 0x288, 0xE308, 0x0 },
        IsEncrypted = false,
        Size = 0x7530,
    };
    ...
    public static readonly DataBlock KBCATRaidPriorityArray = new()
    {
        ...
        Key = 0x095451E4,
        Type = SCTypeCode.Object,
        Pointer = new long[] { 0x46447C0, 0x08, 0x288, 0xE3B0, 0x0 },
        IsEncrypted = false,
        Size = 0x58,
    };
    #endregion
