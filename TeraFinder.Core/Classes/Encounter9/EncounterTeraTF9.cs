...
public sealed record EncounterTeraTF9 : EncounterRaidTF9
{
    ...
    public static EncounterRaidTF9? GetEncounterFromSeed(uint seed, EncounterTeraTF9[] encounters, GameVersion game, GameProgress progress, RaidContent content, TeraRaidMapParent map)
    {
        var xoro = new Xoroshiro128Plus(seed);
        var stars = content is RaidContent.Standard ? GetSeedStars(ref xoro, progress) : (byte)6;
