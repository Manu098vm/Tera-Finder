...
public class DeliveryRaidFixedRewardItemArray : IFlatBufferArchive<DeliveryRaidFixedRewardItem>
{
    [FlatBufferItem(0)] public DeliveryRaidFixedRewardItem[] Table { get; set; }
}

[FlatBufferTable, TypeConverter(typeof(ExpandableObjectConverter))]
public class DeliveryRaidFixedRewardItem
{
