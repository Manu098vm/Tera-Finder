...
public class RaidLotteryRewardItemArray : IFlatBufferArchive<RaidLotteryRewardItem>
{
    [FlatBufferItem(0)] public RaidLotteryRewardItem[] Table { get; set; }
}

[FlatBufferTable, TypeConverter(typeof(ExpandableObjectConverter))]
public class RaidLotteryRewardItem
{
...
{
    [FlatBufferItem(0)] public RaidRewardItemCategoryType Category { get; set; }
...
{
    [FlatBufferItem(0)] public RaidRewardItemCategoryType Category { get; set; }
    [FlatBufferItem(1)] public RaidRewardItemSubjectType SubjectType { get; set; }
