...
public static class SpriteUtil
{
    ...
    public static Image GetSprite(ushort species, byte form, int gender, uint formarg, int item, bool isegg, Shiny shiny, EntityContext context, SpriteBuilderTweak tweak = SpriteBuilderTweak.None)
    {
    ...
    private static Image GetSprite(PKM pk, SpriteBuilderTweak tweak = SpriteBuilderTweak.None)
    {
        ...
        var img = GetSprite(pk.Species, pk.Form, pk.Gender, formarg, pk.SpriteItem, pk.IsEgg, shiny, (EntityContext)pk.Format, tweak);
