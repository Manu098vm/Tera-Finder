...
public static class SpriteName
{
    ...
    /// </summary>
    public static string GetResourceStringSprite(ushort species, byte form, int gender, uint formarg, EntityContext context = EntityContext.Gen9, bool shiny = false)
    {
