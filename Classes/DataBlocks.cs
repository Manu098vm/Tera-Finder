...
namespace TeraFinder
{
    ...
    public static class Blocks
    {
        ...
        public static DataBlock KMassOutbreak01Species = new()
        {
            ...
            Pointer = new long[] { 0x44AAC88, 0xE0, 0x80, 0x8, 0x15B80 }, //Thanks Zyro!
            IsEncrypted = true,
            Size = 4,
        };
        ...
        public static DataBlock KMassOutbreak02Species = new()
        {
            ...
            Key = 0x76A0BCF3,
            Type = SCTypeCode.UInt32,
            Pointer = new long[] { 0x44AAC88, 0xE0, 0x80, 0x8, 0x15B60 }, //Thanks Zyro!
            IsEncrypted = true,
            Size = 4,
        };
        ...
        public static DataBlock KMassOutbreak03Species = new()
        {
            ...
            Key = 0x76A97E38,
            Type = SCTypeCode.UInt32,
            Pointer = new long[] { 0x44AAC88, 0xE0, 0x80, 0x8, 0x15BC0 }, //Thanks Zyro!
            IsEncrypted = true,
            Size = 4,
        };
        ...
        public static DataBlock KMassOutbreak04Species = new()
        {
            ...
            Key = 0x76A6E26D,
            Type = SCTypeCode.UInt32,
            Pointer = new long[] { 0x44AAC88, 0xE0, 0x80, 0x8, 0x15BA0 }, //Thanks Zyro!
            IsEncrypted = true,
            Size = 4,
        };
        ...
        public static DataBlock KMassOutbreak05Species = new()
        {
            ...
            Key = 0x76986F3A,
            Type = SCTypeCode.UInt32,
            Pointer = new long[] { 0x44AAC88, 0xE0, 0x80, 0x8, 0x15B00 }, //Thanks Zyro!
            IsEncrypted = true,
            Size = 4,
        };
        ...
        public static DataBlock KMassOutbreak06Species = new()
        {
            ...
            Key = 0x76947F97,
            Type = SCTypeCode.UInt32,
            Pointer = new long[] { 0x44AAC88, 0xE0, 0x80, 0x8, 0x15AC0 }, //Thanks Zyro!
            IsEncrypted = true,
            Size = 4,
        };
        ...
        public static DataBlock KMassOutbreak07Species = new()
        {
            ...
            Key = 0x769D40DC,
            Type = SCTypeCode.UInt32,
            Pointer = new long[] { 0x44AAC88, 0xE0, 0x80, 0x8, 0x15B40 }, //Thanks Zyro!
            IsEncrypted = true,
            Size = 4,
        };
        ...
        public static DataBlock KMassOutbreak08Species = new()
        {
            ...
            Key = 0x769B11D1,
            Type = SCTypeCode.UInt32,
            Pointer = new long[] { 0x44AAC88, 0xE0, 0x80, 0x8, 0x15B20 }, //Thanks Zyro!
            IsEncrypted = true,
            Size = 4,
        };
